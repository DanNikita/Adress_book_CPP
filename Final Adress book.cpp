...
#include <windows.h>
using namespace std;
class Human // Class Human is base class for all phone book participants: Inheritance
{
public:
    Human (){}
    ...
    virtual void Showinfo() // Virtual function - example of polymorphism
    {
        cout << "\n Name: " << name;
        cout << "\n Surname: " << surname;
    }
...
class Phonecard // This class shows the association relations and stores one person value
{
private: 
    string number;
    string type;
...
class Friend : public Human // GoF prototype?
{
private:
...
class Phonebook // Class is used to store list of phonecards GoF composite?
{
private:
